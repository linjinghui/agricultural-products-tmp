    ...
    <div style="padding: 0 20px;" v-show="optionTab.current.id===1">
      ...
      <cmp-table ref="rtable" v-bind="optionTabel">
        <tr slot="head">
          ...
          <td @click="clkOrder('optUserName')">姓名</td>
...
<script>
  ...
  import {ajaxGetChildDivision, ajaxGetJgyhOptLogList} from '../../../data/ajax.js';
  ...
  export default {
    ...
    methods: {
      ...
      callbackPagebar: function (data) {
        ...
        ajaxGetJgyhOptLogList(Object.assign({
