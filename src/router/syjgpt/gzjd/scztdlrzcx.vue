...
<script>
  ...
  import {ajaxGetChildDivision, ajaxGetScztLoginLogList} from '../../../data/ajax.js';
  ...
  export default {
    ...
    methods: {
      ...
      callbackPagebar: function (data) {
        ...
        ajaxGetScztLoginLogList(Object.assign({
