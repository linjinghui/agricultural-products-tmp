  ...
  <div class="wrap">
    ...
    <div style="padding: 0 20px;">
      <div class="wrap-form horiz" :class="{'show': formShow}">
        ...
        <div class="form-layer">
          <label class="star">批次码:</label>
          <cmp-input class="f-dom" v-model="query._ztmc_" maxlength="50"></cmp-input>
        </div>
        <div class="form-layer">
          <label class="star">溯源码:</label>
          <cmp-input class="f-dom" v-model="query._ztmc_" maxlength="50"></cmp-input>
        </div>
      ...
      <cmp-table v-bind="optionTabel">
        <tr slot="head">
          <td>主体名称</td><td>经营场所</td><td>赋码日期</td><td>产业类型</td><td>产品名称</td><td>批次码</td><td>溯源码</td><td>产出数量</td>
        </tr>
        <tr slot="body" slot-scope="props">
          <td>{{props.item._ztmc_}}</td><td>{{props.item._jycs_}}</td><td>{{props.item._fddbr_}}</td><td>{{props.item._cylx_}}</td><td>{{props.item._ztxz_}}</td><td>{{props.item._ztxz_}}</td><td>{{props.item._ztxz_}}</td><td>{{props.item._ztxz_}}</td>
        </tr>
      </cmp-table>
